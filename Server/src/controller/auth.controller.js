...
import { generateSixDigitOTP, oneMinuteExpiry, threeMinuteExpiry } from "../constant/otp.js";
...
import { resetPasswordTemplate } from "../utils/htmlTempelate.js";
...
export const forgetPasswordCtrl = asyncHandler(async (req, res) => {
    ...
    if (!otpDoc) {
        ...
        otpDoc.otp = generateSixDigitOTP();
